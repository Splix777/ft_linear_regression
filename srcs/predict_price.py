...
def predict():
    ...
    try:
        ...
        user_input = input("The trained parameters were not found. Do you want to train the model? (y/n): ")
        if user_input.lower() != 'y':
            raise FileNotFoundError("The trained parameters were not found.") from e
